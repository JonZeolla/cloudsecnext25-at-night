# Claude Instructions for cloudsecnext25-at-night
...
- **Name**: cloudsecnext25-at-night
- **Package**: cloudsecnext25_at_night
...
```
cloudsecnext25_at_night/    # Main package code
...
### Error Handling
```python
class Cloudsecnext25AtNightError(Exception):
    """Base exception for cloudsecnext25-at-night."""
    pass

class ConfigurationError(Cloudsecnext25AtNightError):
